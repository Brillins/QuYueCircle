...
public class WaterDrop extends RelativeLayout {
    ...
    public void setOnDragCompeteListener(com.lovejoy.drop.DropCover.OnDragCompeteListener onDragCompeteListener) {
        mOnDragCompeteListener = (com.lovejoy.drop.DropCover.OnDragCompeteListener) onDragCompeteListener;
    }
}
