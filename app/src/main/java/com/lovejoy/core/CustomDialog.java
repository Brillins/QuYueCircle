	...
	public static class Builder {
       ...
       public EditText ed;
		...
		public CustomDialog create() {
           ...
           ed=(EditText) layout.findViewById(R.id.commentcontent);
			...
			if (message != null) {
				...
				((TextView) layout.findViewById(R.id.message)).setTypeface( MDFontsUtils.getTypeface(context,"fonts/Roboto-Black.ttf"));
