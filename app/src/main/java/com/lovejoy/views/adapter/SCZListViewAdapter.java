...
public class SCZListViewAdapter extends BaseAdapter{
    ...
    public SCZListViewAdapter(Context context,List<Map<String, Object>> data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        itemComponent.creatorImage.setImageBitmap((Bitmap) data.get(position).get("pic"));
        return convertView;
    }
